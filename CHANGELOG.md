...
- Added a shared quota refresh action beside Copy in every provider's Last quota response header.
- Refined Antigravity UI with a Detect button, an explicitly labeled Google documentation link, and shorter weekly labels.
