...
- **Auth:** API key stored in IntelliJ Password Safe through the settings GUI
...
2. Open the Z.ai tab in OpenUsage settings
3. Paste the API key and save it. The key is stored in IntelliJ Password Safe.
...
| Condition     | Message                                                    |
|---------------|------------------------------------------------------------|
| No API key    | "No Z.ai API key configured"                              |
